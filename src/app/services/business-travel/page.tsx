...
export const metadata = {
  title: 'Business Travel | Oxford VIP Chauffeurs',
};
      ...
      <section className="section">
        <div className="container">
          <div className="glass-panel" style={{ padding: '3rem', maxWidth: '900px', margin: '0 auto' }}>
            ...
            <p style={{ marginBottom: "1.5rem", color: "var(--text-secondary)", lineHeight: 1.8 }}>Business Travel & Corporate Chauffeur by Oxford VIP Chauffeurs</p>
            ...
            <p style={{ marginBottom: "1.5rem", color: "var(--text-secondary)", lineHeight: 1.8 }}>Finding a chauffeur that offers luxury and reliability can often prove to be a trickier task than you might first think, but with Oxford VIP Chauffeurs you can be rest assured that you’ll receive the finest service every time.</p>
