...
export const metadata = {
  title: 'Tours | Oxford VIP Chauffeurs',
};
      ...
      <section className="section">
        <div className="container">
          <div className="glass-panel" style={{ padding: '3rem', maxWidth: '900px', margin: '0 auto' }}>
            ...
            <p style={{ marginBottom: "1.5rem", color: "var(--text-secondary)", lineHeight: 1.8 }}>Chauffeur Driven Tours in Oxfordshire from Oxford VIP Chauffeurs</p>
            ...
            <p style={{ marginBottom: "1.5rem", color: "var(--text-secondary)", lineHeight: 1.8 }}>As Oxfordshire’s premier chauffeur provider, at Oxford VIP Chauffeurs we excel in providing guided tours throughout the region and beyond. Whether you’re looking to have a sightseeing tour of Oxford, an in-depth tour of the Cotswolds or even want to have a chauffeur driven journey to London, we can design a tour travel package that’s perfect for your requirements.</p>
